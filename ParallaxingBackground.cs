...
namespace Shooter
{
    class ParallaxingBackground
    {
        ...
        // The parallaxing backgrounds proportions
        int bgHeight;
        int bgWidth;
        ...
        public void Initialize(ContentManager content, String texturePath, int screenWidth, int screenHeight, int speed)
        {
            ...
            // If we divide the screen with the texture width then we can determine the number off tiles needed.
        ...
        {
            // If the textures are scrolling to the left, when the tile wraps, it should be put at the one pixel to the right of the tile before it
        ...
        {
            // If the textures are scrolling to the right, when the tile wraps, it should be plaes to the left of the tile that comes after it
